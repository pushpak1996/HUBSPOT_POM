...
class DocumentPage(SeleniumDriver):
    ...
    list = doc_path.split("/")
    verifyitem = list[2]
    _VerifyCreate = "//a/span/span/span[.='" + verifyitem + "']"                                                        #xpath
    _CheckboxResume = "//span[.='" + verifyitem + "']/../../../../../../../../../../../td[1]/div/div/label/span/span"   #xpath
    ...
    def CreateDocument(self):
        ...
        time.sleep(1)
        keyboard.SendKeys("G:\Test_Data\questions.xlsx")
    ...
    def VerifyCreate(self):
        time.sleep(30)
        self.sendKeys(self.list[2], self._Search, locatorType="css")
